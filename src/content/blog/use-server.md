...
pubDate: 'Jul 31 2024'
heroImage: '/aliyun-logo.png'
pinned: TRUE
---
> ### 目录
>  - [白嫖](#白嫖)
>   - [阿里学生认证可以白嫖300块钱额度](#阿里学生认证可以白嫖300块钱额度)
>   - [购买了一台最便宜的服务器 -285](#购买了一台最便宜的服务器--285)
> - [防火墙相关](#防火墙相关)
> - [ssh连接](#ssh连接)
>   - [确保 SSH 服务器在 Debian 上运行](#确保-ssh-服务器在-debian-上运行)
>   - [获取服务器的 IP 地址](#获取服务器的-ip-地址)
>   - [关于没有公网ip只有私网ip的情况](#关于没有公网ip只有私网ip的情况)
>   - [ssh链接](#ssh链接)
>     - [Windows 系统下载 Git for Windows](#windows-系统下载-git-for-windows)
>     - [使用 Git Bash 进行 SSH 连接](#使用-git-bash-进行-ssh-连接)
>     - [使用 MobaXterm Personal 链接](#使用-mobaxterm-personal-链接)
> - [Nginx 反代](#nginx-反代)
>   - [例子](#例子)
>   - [Nginx部分](#nginx部分)
>   - [还是不能用？](#还是不能用)
>   - [成功了的样子](#成功了的样子)
>   - [一关掉终端就外部进入不了网页 使用PM2](#成功了的样子)
>     - [安装 PM2](#安装-pm2)
>     - [启动应用](#启动应用)
>     - [保存进程列表](#保存进程列表)
>     - [配置开机自启（可选）](#配置开机自启可选)
